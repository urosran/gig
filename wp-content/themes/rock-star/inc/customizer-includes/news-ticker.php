...
$featured_slider_content_options = rock_star_featured_slider_content_options();
$choices = array();
...
$news_ticker_positions = rock_star_news_ticker_positions();
$choices = array();
foreach ( $news_ticker_positions as $news_ticker_position ) {
	$choices[$news_ticker_position['value']] = $news_ticker_position['label'];
}
...
$news_ticker_transition_effects = rock_star_featured_slide_transition_effects();
$choices = array();
foreach ( $news_ticker_transition_effects as $news_ticker_transition_effect ) {
	$choices[$news_ticker_transition_effect['value']] = $news_ticker_transition_effect['label'];
}
...
$news_ticker_types = rock_star_news_ticker_types();
$choices = array();
foreach ( $news_ticker_types as $news_ticker_type ) {
	$choices[$news_ticker_type['value']] = $news_ticker_type['label'];
}
