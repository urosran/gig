...
$enable_featured_header_image_options = rock_star_enable_featured_header_image_options();
$choices = array();
foreach ( $enable_featured_header_image_options as $enable_featured_header_image_option ) {
	$choices[$enable_featured_header_image_option['value']] = $enable_featured_header_image_option['label'];
}
...
$featured_image_size_options = rock_star_featured_image_size_options();
$choices = array();
foreach ( $featured_image_size_options as $featured_image_size_option ) {
	$choices[$featured_image_size_option['value']] = $featured_image_size_option['label'];
}
